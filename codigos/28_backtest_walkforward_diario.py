# INVALIDADO / SUPERADO (2026-09-23) - el backtest diario PPO/umbral cobre/umbral simple (ademas UMBRAL_SIMPLE usaba la mediana de todo el dataset, incluido test): ver script 64 + 65.
