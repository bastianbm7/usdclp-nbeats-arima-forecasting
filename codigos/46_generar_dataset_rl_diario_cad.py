...
# costos en 27/32/36.
#
# Issue #12: dataset walk-forward diario para USD/CAD, mismo patron que
...
# a bajar petroleo (el commodity fundamental real de CAD, segun el
# radar-baseline de 2026-09-17) - decision explicita: esto testea si el
# efecto cobre generico tambien aplica a CAD, no si el petroleo lo hace
# mejor. CAD tiene ademas señales de alerta documentadas (reversion de signo
# historica del Banco de Canada, decoupling reciente con petroleo) - un
# resultado positivo o negativo aca no cierra la pregunta de fondo.
...
if __name__ == "__main__":
    ...
    print(f"\n[4/4] Features de cobre (copper_ret_1d, copper_mom_5d) - senial generica, NO el commodity fundamental real de CAD (petroleo)...")
    ...
    dataset.to_csv(f"{RESULTADOS_DIR}/dataset_entrenamiento_rl_diario_cad.csv", index=False)
