# INVALIDADO / SUPERADO (2026-09-23) - el backtest NZD: ver script 64 (lote A) + 65.
...
# pero sobre el dataset de NZD/USD (47_generar_dataset_rl_diario_nzd.py).
# Recordatorio del caveat del Issue: esto testea la senal GENERICA de cobre
# sobre NZD, no el commodity fundamental real de NZD (lacteos, radar-baseline
# 2026-09-17). Un resultado negativo aca no cierra la pregunta de si NZD
# tiene edge via lacteos; haria falta esa serie propia para saberlo.
...
DATASET_PATH = "../datos/resultados/dataset_entrenamiento_rl_diario_nzd.csv"
RESULTADOS_DIR = "../datos/resultados"
NOMBRE_ACTIVO = "NZD/USD"
SUFIJO = "nzd"


def posiciones_umbral_cobre_apreciacion(df_test, umbral=0.0):
    # Ver nota en 48_backtest_walkforward_diario_aud.py: el dataset de NZD
    # sale del panel (panel_fx_diario.csv), ya normalizado a "USD por 1 NZD"
    # (cobre sube -> NZD se aprecia -> y SUBE) - signo opuesto al de
